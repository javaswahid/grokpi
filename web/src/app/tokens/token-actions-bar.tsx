    ...
    <div className="flex flex-wrap gap-2 md:justify-end">
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-52">
          ...
          <DropdownMenuItem onClick={() => onSelectByStatus('quota_exhausted')}>Select All Quota Exhausted</DropdownMenuItem>
          <DropdownMenuItem onClick={() => onSelectByStatus('invalid')}>Select All Invalid</DropdownMenuItem>
          <DropdownMenuItem onClick={() => onSelectByStatus('refresh_required')}>Select All Refresh Required</DropdownMenuItem>
          <DropdownMenuItem onClick={() => onSelectByStatus('refresh_failed')}>Select All Refresh Failed</DropdownMenuItem>
