...
export interface TokenConfigResponse {
  ...
  max_chat_quota: number
  max_image_quota: number
  max_video_quota: number
  allow_unlimited_quota: boolean
  token_health_check_interval_minutes: number
  token_expiry_warning_hours: number
  token_critical_expiry_hours: number
  allow_token_auto_refresh: boolean
  require_official_refresh_flow: boolean
