...
export function TokenFilterTabs({ activeTab, onTabChange }: TokenFilterTabsProps) {
  ...
  const statusTabs = [
    ...
    { key: 'quota_exhausted', label: 'Quota Exhausted', color: 'bg-orange-50 text-orange-700 border-orange-200' },
    { key: 'invalid', label: 'Invalid', color: 'bg-purple-50 text-purple-700 border-purple-200' },
    { key: 'refresh_required', label: 'Refresh Required', color: 'bg-pink-50 text-pink-700 border-pink-200' },
    { key: 'refresh_failed', label: 'Refresh Failed', color: 'bg-red-50 text-red-700 border-red-200' },
  ] as const
