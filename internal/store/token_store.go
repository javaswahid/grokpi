...
const (
	...
	TokenStatusQuotaExhausted   = "quota_exhausted"
	TokenStatusInvalid          = "invalid"
	TokenStatusRefreshRequired  = "refresh_required"
	TokenStatusRefreshFailed    = "refresh_failed"
	TokenStatusPolicyQuarantine = "policy_quarantine"
	TokenStatusRateLimited      = "rate_limited"
	TokenStatusNeedsManualCheck = "needs_manual_check"
)
	...
	return s.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
		for _, snap := range snapshots {
			updates := map[string]any{
				...
				"last_validated_at":       snap.LastValidatedAt,
				"last_refresh_attempt_at": snap.LastRefreshAttemptAt,
				"refresh_status":          snap.RefreshStatus,
				"refresh_error":           snap.RefreshError,
				"refresh_count":           snap.RefreshCount,
				"token_version":           snap.TokenVersion,
				"replaced_at":             snap.ReplacedAt,
			}
