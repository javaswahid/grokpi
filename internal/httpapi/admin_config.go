...
func configToResponse(cfg *config.Config) ConfigResponse {
	return ConfigResponse{
		...
		Token: TokenConfigResponse{
			...
			MaxChatQuota:                    cfg.Token.MaxChatQuota,
			MaxImageQuota:                   cfg.Token.MaxImageQuota,
			MaxVideoQuota:                   cfg.Token.MaxVideoQuota,
			AllowUnlimitedQuota:             cfg.Token.AllowUnlimitedQuota,
			TokenHealthCheckIntervalMinutes: cfg.Token.TokenHealthCheckIntervalMinutes,
			TokenExpiryWarningHours:         cfg.Token.TokenExpiryWarningHours,
			TokenCriticalExpiryHours:        cfg.Token.TokenCriticalExpiryHours,
			AllowTokenAutoRefresh:           cfg.Token.AllowTokenAutoRefresh,
			RequireOfficialRefreshFlow:      cfg.Token.RequireOfficialRefreshFlow,
