...
type TokenConfigResponse struct {
	...
	MaxChatQuota                    int      `json:"max_chat_quota"`
	MaxImageQuota                   int      `json:"max_image_quota"`
	MaxVideoQuota                   int      `json:"max_video_quota"`
	AllowUnlimitedQuota             bool     `json:"allow_unlimited_quota"`
	TokenHealthCheckIntervalMinutes int      `json:"token_health_check_interval_minutes"`
	TokenExpiryWarningHours         int      `json:"token_expiry_warning_hours"`
	TokenCriticalExpiryHours        int      `json:"token_critical_expiry_hours"`
	AllowTokenAutoRefresh           bool     `json:"allow_token_auto_refresh"`
	RequireOfficialRefreshFlow      bool     `json:"require_official_refresh_flow"`
...
type TokenConfigUpdate struct {
	...
	MaxChatQuota                    *int      `json:"max_chat_quota,omitempty"`
	MaxImageQuota                   *int      `json:"max_image_quota,omitempty"`
	MaxVideoQuota                   *int      `json:"max_video_quota,omitempty"`
	AllowUnlimitedQuota             *bool     `json:"allow_unlimited_quota,omitempty"`
	TokenHealthCheckIntervalMinutes *int      `json:"token_health_check_interval_minutes,omitempty"`
	TokenExpiryWarningHours         *int      `json:"token_expiry_warning_hours,omitempty"`
	TokenCriticalExpiryHours        *int      `json:"token_critical_expiry_hours,omitempty"`
	AllowTokenAutoRefresh           *bool     `json:"allow_token_auto_refresh,omitempty"`
	RequireOfficialRefreshFlow      *bool     `json:"require_official_refresh_flow,omitempty"`
