...
// SetupModelRoutes registers root-level OpenAI-compatible model aliases.
func (h *Handler) SetupModelRoutes(r chi.Router) {
	if h.Runtime != nil {
...
// SetupAudioRoutes registers root-level OpenAI-compatible audio aliases.
func (h *Handler) SetupAudioRoutes(r chi.Router) {
	r.Post("/audio/speech", h.handleSpeech)
}
